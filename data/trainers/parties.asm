...
FalknerGroup:
	; FALKNER (1)
	db "ALI@", TRAINERTYPE_MOVES
	db  9,  HOOTHOOT,  HYPNOSIS, DREAM_EATER, NO_MOVE, NO_MOVE
	db  11, NATU, 	   NIGHT_SHADE, PSYCHIC_M, PECK, GIGA_DRAIN
	db  10, DELIBIRD,  PRESENT, NO_MOVE, NO_MOVE, NO_MOVE
	db  11, GLIGAR,    DIG, EARTHQUAKE, TOXIC, SANDSTORM
	db  13, MANTINE,   HYDRO_PUMP, ICE_BEAM, REST, SLEEP_TALK
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "LOUISE@", TRAINERTYPE_MOVES
	db 19, TEDDIURSA,  ZAP_CANNON, EARTHQUAKE, SLASH, TOXIC
	db 20, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db 22, BLISSEY,	   FLAMETHROWER, ICE_BEAM, THUNDERBOLT, SOFTBOILED
	db 18, SNORLAX,	   REST, BODY_SLAM, SHADOW_BALL, AMNESIA
	db 24, PORYGON2,   PSYCHIC_M, ZAP_CANNON, ICE_BEAM, TOXIC
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "ARAN@", TRAINERTYPE_MOVES
	db 17, SHUCKLE,       ATTRACT, EARTHQUAKE, TOXIC, HEADBUTT
	db 14, HERACROSS,     EARTHQUAKE, DETECT, MEGAHORN, REVERSAL
	db 14, YANMA,         SONICBOOM, GIGA_DRAIN, WING_ATTACK, HEADBUTT
	db 15, VENOMOTH,      PSYCHIC_M, SLUDGE_BOMB, TOXIC, SUPERSONIC
	db 18, ARIADOS,	      NIGHT_SHADE, SCARY_FACE, DIG, SLUDGE_BOMB
	db -1 ; end
